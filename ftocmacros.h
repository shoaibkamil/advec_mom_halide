...
//int FTNREF2D(int i_index, int j_index, int i_size, int i_lb, int j_lb) {
//  printf("%d,%d,%d,%d,%d: %d\n", i_index, j_index, i_size, i_lb, j_lb, ((i_size)*(j_index-(j_lb))+(i_index)-(i_lb)));
//  return ((i_size)*(j_index-(j_lb))+(i_index)-(i_lb));
//}
